...
const ProjectSubmission = () => {
  return (
    <div className="p-[120px] flex flex-col items-center justify-center gap-[60px] bg-surface">
      ...
      <div className="flex gap-[40px] justify-stretch relative w-full">
        <div className="w-full h-[1px] bg-border absolute top-0 left-[50%] translate-x-[-50%]" />
        {steps.map((step, index) => (
          <div key={index} className="flex-1 flex flex-col gap-[15px]">
